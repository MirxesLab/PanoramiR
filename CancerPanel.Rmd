...
pheatmap(allmiRNA, 
         scale = 'row',
         show_rownames = ifelse(nrow(allmiRNA) > 20, FALSE, TRUE),
         show_colnames = ifelse(ncol(allmiRNA) > 20, FALSE, TRUE),
         border_color = ifelse(nrow(allmiRNA) > 20, NA, 'lightgrey'),
         col = colors.heatmap,
         annotation_col = df.anno.all,
         annotation_names_col = FALSE,
         annotation_colors = color.anno.all,
         main = "Clustergram analysis for Sample-miRNA")
