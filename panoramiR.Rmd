...
The threshold Ct value is based on QC data specific to each assay. MiRNAs in each samples with Ct values less than it corresponding threshold are selected for later analysis, otherwise miRNAs are considered as non-detect ; Expression figures below shows the number of detected miRNAs in each samples.
